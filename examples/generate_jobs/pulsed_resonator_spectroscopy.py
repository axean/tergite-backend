...
def generate_job():
    ...
    job = {
        ...
        "params": {
            ...
            "control_output_enabled": 0,  # & output off, we do not want to perturb qubit
            ...
            # qubit excitation frequency = "control_freq" + "control_if_freq"
            # should be replaced by the measured variable
            "control_freq": 274.68e6,
            ...
            "readout_freq_range_type": "Start - Stop",  # & doing a frequency sweep around expected resosnace freq
            "readout_freq": 379.17e6,  # & close to expected resonance frequency, :config
            "readout_start_freq": 5.99e9,  # &
            "readout_stop_freq": 6.01e9,  # &
            "readout_resonance_freq": 5.99931e9,  # resonance determined by pulsed_res_spect
            ...
            "readout_power_start": -20,
            "readout_power_stop": 0,
...
"""
    ...
    ---------
          ##  _range_type: sweeping direction, valid values: "Start - Stop", "Span", "Single"
            ...
            "integration_window_start": Defines start time when a window is used to define integration scope
