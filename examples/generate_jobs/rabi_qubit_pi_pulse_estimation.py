...
def generate_job():
    ...
    job = {
        ...
        "params": {
            ...
            "control_freq": 274.68e6,  # & qubit excitation frequency = "control_freq" + "control_if_freq"
            # should be replaced by the measured variable
            "control_amp_range_type": "Start - Stop",  # & rabi power sweep
            "control_amp": 20e-3,
            ...
            "num_pts": 200,  # & 1 mV to 200 mV, 200 points = 1 mV sweep resolation
